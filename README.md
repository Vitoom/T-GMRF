...
3. Run quick test of T-GMRF on small dataset, BasicMotions, opened from [UEA Repo](http://www.timeseriesclassification.com/dataset.php).
```bash
cd T-GMRF/
python Run_Test.py
```
...
Partially open source codes of the compared baselines.
